...
public class PottersLootTables extends FabricBlockLootTableProvider {
    public PottersLootTables(FabricDataOutput dataOutput) {
        super(dataOutput);
    }

    @Override
    public void generate() {
        addDrop(PottersBlocks.IRON_DECORATED_POT, this::finiteDecoratedPotDrops);
        addDrop(PottersBlocks.GOLD_DECORATED_POT, this::finiteDecoratedPotDrops);
        addDrop(PottersBlocks.DIAMOND_DECORATED_POT, this::finiteDecoratedPotDrops);
        addDrop(PottersBlocks.NETHERITE_DECORATED_POT, this::finiteDecoratedPotDrops);
            ...
            .pool(LootPool.builder()
                      ...
                      .with(ItemEntry.builder(block)
                                .apply(CopyNbtLootFunction.builder(ContextLootNbtProvider.BLOCK_ENTITY)
                                           ...
                                           .withOperation("sherds", "BlockEntityTag.sherds")
                                           .withOperation("variant", "BlockEntityTag.variant")
                                           .withOperation("count", "BlockEntityTag.count"))
                                .alternatively(ItemEntry.builder(block)
                                                   .apply(CopyNbtLootFunction.builder(ContextLootNbtProvider.BLOCK_ENTITY)
                                                              .withOperation("sherds", "BlockEntityTag.sherds")))));
    }
