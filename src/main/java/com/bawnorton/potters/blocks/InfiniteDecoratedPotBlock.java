...
import com.bawnorton.potters.blocks.entity.InfiniteDecoratedPotBlockEntity;
...
public class InfiniteDecoratedPotBlock extends PottersDecoratedPotBlockBase {
    private static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    private static final BooleanProperty CRACKED = Properties.CRACKED;
    private static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;

    public InfiniteDecoratedPotBlock(Settings settings) {
        super(settings);
