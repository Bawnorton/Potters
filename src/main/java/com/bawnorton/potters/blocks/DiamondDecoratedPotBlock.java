...
import com.bawnorton.potters.blocks.entity.DiamondDecoratedPotBlockEntity;
...
public class DiamondDecoratedPotBlock extends PottersDecoratedPotBlockBase {
    private static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    private static final BooleanProperty CRACKED = Properties.CRACKED;
    private static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;

    public DiamondDecoratedPotBlock(Settings settings) {
        super(settings);
    ...
    protected BlockEntityType<? extends PottersDecoratedPotBlockEntityBase> getBlockEntityType() {
        return PottersBlockEntityType.DIAMOND_DECORATED_POT;
    }

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new DiamondDecoratedPotBlockEntity(pos, state);
    }
}