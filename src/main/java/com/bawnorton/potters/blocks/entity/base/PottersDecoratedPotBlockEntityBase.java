...
public abstract class PottersDecoratedPotBlockEntityBase extends BlockEntity {
    private Storage<ItemVariant> inventoryWrapper;
    ...
    public Storage<ItemVariant> getInventoryWrapper() {
        if (inventoryWrapper == null) inventoryWrapper = InventoryStorage.of(getInventory(), null);
        return inventoryWrapper;
    }

    public abstract PottersDecoratedPotInventoryBase getInventory();

    public Number getItemCount() {
        return getInventory().getCount();
    }
