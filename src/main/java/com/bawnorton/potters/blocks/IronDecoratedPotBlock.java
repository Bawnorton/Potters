...
import com.bawnorton.potters.blocks.entity.IronDecoratedPotBlockEntity;
...
public class IronDecoratedPotBlock extends PottersDecoratedPotBlockBase {
    ...
    protected BlockEntityType<? extends PottersDecoratedPotBlockEntityBase> getBlockEntityType() {
        return PottersBlockEntityType.IRON_DECORATED_POT;
    }

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new IronDecoratedPotBlockEntity(pos, state);
    }
}