...
import com.bawnorton.potters.blocks.entity.NetheriteDecoratedPotBlockEntity;
...
public class NetheriteDecoratedPotBlock extends PottersDecoratedPotBlockBase {
    private static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    private static final BooleanProperty CRACKED = Properties.CRACKED;
    private static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;

    public NetheriteDecoratedPotBlock(Settings settings) {
        super(settings);
    ...
    protected BlockEntityType<? extends PottersDecoratedPotBlockEntityBase> getBlockEntityType() {
        return PottersBlockEntityType.NETHERITE_DECORATED_POT;
    }

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new NetheriteDecoratedPotBlockEntity(pos, state);
    }
}
